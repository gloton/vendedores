...
{
	document.frm_envio_cheques.submit();
}
}
...
<body>
<h1>Envió de cheques</h1>
<div style="display:none; font-size: 24px; color: red; background-color: yellow; margin-bottom: 20px; height: 60px;">MIENTRAS APAREZCA ESTE AVISO NO UTILICE ESTE FORMULARIO PUES ESTA EN PROCESO DE ACTUALIZACION</div>
<form name="frm_envio_cheques" id="frm_envio_cheques" action="mail-envio-cheques.php" method="post">
	<table class="reporte_depositos" width="972" border="1" align="center" bgcolor="#FFFFFF">
		...
		<tr class="fila1">
			<td><input name="nrocheque_1" id="nrocheque_1" type="text" value="" /></td>
			<td><input name="banco_1" type="text" value="" /></td>
			<td align="center"><input name="nombre_1" type="text" value="" /></td>
			<td align="center"><input name="nfactura_1" type="text" value="" /></td>
		  <td><input name="fecha_1" type="text" value="" /></td>
		  <td align="center"><input name="monto_1" type="text" value="" /></td>
			<td align="center"><div class="alertar"></div></td>
		</tr>
		<tr class="fila2">
			<td><input name="nrocheque_2" type="text" value="" /></td>
			<td><input name="banco_2" type="text" value="" /></td>
			<td align="center"><input name="nombre_2" type="text" value="" /></td>
			<td align="center"><input name="nfactura_2" type="text" value="" /></td>
		  <td><input name="fecha_2" type="text" value="" /></td>
		  <td align="center"><input name="monto_2" type="text" value="" /></td>
			<td align="center"><div class="alertar"></div></td>
		</tr>
		<tr class="fila3">
			<td><input name="nrocheque_3" type="text" value="" /></td>
			<td><input name="banco_3" type="text" value="" /></td>
			<td align="center"><input name="nombre_3" type="text" value="" /></td>
			<td align="center"><input name="nfactura_3" type="text" value="" /></td>
		  <td><input name="fecha_3" type="text" value="" /></td>
		  <td align="center"><input name="monto_3" type="text" value="" /></td>
			<td align="center"><div class="alertar"></div></td>
		</tr>
		<tr class="fila4">
			<td><input name="nrocheque_4" type="text" value="" /></td>
			<td><input name="banco_4" type="text" value="" /></td>
			<td align="center"><input name="nombre_4" type="text" value="" /></td>
			<td align="center"><input name="nfactura_4" type="text" value="" /></td>
		  <td><input name="fecha_4" type="text" value="" /></td>
		  <td align="center"><input name="monto_4" type="text" value="" /></td>
			<td align="center"><div class="alertar"></div></td>
		</tr>
		<tr class="fila5">
			<td><input name="nrocheque_5" type="text" value="" /></td>
			<td><input name="banco_5" type="text" value="" /></td>
			<td align="center"><input name="nombre_5" type="text" value="" /></td>
			<td align="center"><input name="nfactura_5" type="text" value="" /></td>
		  <td><input name="fecha_5" type="text" value="" /></td>
		  <td align="center"><input name="monto_5" type="text" value="" /></td>
			<td align="center"><div class="alertar"></div></td>
		</tr>
		<tr class="fila6">
			<td><input name="nrocheque_6" type="text" value="" /></td>
			<td><input name="banco_6" type="text" value="" /></td>
			<td align="center"><input name="nombre_6" type="text" value="" /></td>
			<td align="center"><input name="nfactura_6" type="text" value="" /></td>
		  <td><input name="fecha_6" type="text" value="" /></td>
		  <td align="center"><input name="monto_6" type="text" value="" /></td>
			<td align="center"><div class="alertar"></div></td>
		</tr>
		<tr class="fila7">
			<td><input name="nrocheque_7" type="text" value="" /></td>
			<td><input name="banco_7" type="text" value="" /></td>
			<td align="center"><input name="nombre_7" type="text" value="" /></td>
			<td align="center"><input name="nfactura_7" type="text" value="" /></td>
		  <td><input name="fecha_7" type="text" value="" /></td>
		...
		<tr>
		  ...
		  <td align="center">
				...
				<input type="hidden" name="correo_vendedor" value="<?=$correo_vendedor;?>" />		  
		  		<input style="cursor:pointer" name="enviar" title="Enviar reporte" value="Enviar reporte" onclick="enviarFormulario();" /> 
          </td>
			<td align="center">&nbsp;</td>
		</tr>
	</table>
