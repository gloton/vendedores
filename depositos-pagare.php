...
<title>Depósitos en efectivo de pagares / letra</title>
...
{
	document.frm_depositos_pagare.submit();
}
}
...
<body>
<h1>Depósitos en efectivo de pagares / letra</h1>
<form name="frm_depositos_pagare" action="mail-depositos-pagare.php" method="post">
	<table class="reporte_depositos" width="933" border="1" align="center" bgcolor="#FFFFFF">
		<tr bgcolor="#FFFF00">
			<th width="171" scope="col">Nombre del deudor</th>
			<th width="208" scope="col">N°de factura asociada al pagaré</th>
			<th width="135" scope="col">Monto del deposito</th>
			<th width="108" scope="col">día del deposito</th>
		...
		<tr class="fila1">
			...
			<td><input name="nfactura_1" type="text" value="" /></td>
		...
		<tr>
		  ...
		  <td align="center">
				...
				<input type="hidden" name="correo_vendedor" value="<?=$correo_vendedor;?>" />		  
		  		<input style="cursor:pointer" name="enviar" title="Enviar depositos" value="Enviar reporte pagare" onclick="enviarFormulario();" />
		  </td>
			<td align="center">&nbsp;</td>
		</tr>
	</table>
