...
{
	document.frm_envio_pagares.submit();
}
}
...
<body>
<h1>Envió de pagares</h1>
<form name="frm_envio_pagares" action="mail-envio-pagares.php" method="post">
	<table class="reporte_depositos" width="933" border="1" align="center" bgcolor="#FFFFFF">
		...
		<tr class="fila1">
			<td><input name="nombre_1" id="nombre_1" type="text" value="" /></td>
			<td><input name="nrofactura_1" type="text" value="" /></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td align="center">&nbsp;</td>
			<td align="center"><input type="hidden" name="nombre_vendedor" value="<?=$nombre_vendedor;?>" />
				...
				<input type="hidden" name="correo_vendedor" value="<?=$correo_vendedor;?>" />		  
		  		<input style="cursor:pointer" name="enviar" title="Enviar reporte" value="Enviar reporte" onclick="enviarFormulario();" /></td>
		  <td align="center">&nbsp;</td>
		</tr>
	</table>
</form>
